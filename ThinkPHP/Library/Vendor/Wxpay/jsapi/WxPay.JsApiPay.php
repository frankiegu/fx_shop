...
class JsApiPay
{
	...
	{	
		$getData = $this->data;
		$data = array();
		$data["appid"] = \WxPayConfig::getValue('appid');
		...
		$afterData = array(
			...
			"signType" => "sha1",
			"scope" => "jsapi_address",
			"appId" => \WxPayConfig::getValue('appid'),
	...
	{
		$urlObj["appid"] = \WxPayConfig::getValue('appid');
	...
	{
		$urlObj["appid"] = \WxPayConfig::getValue('appid');
		$urlObj["secret"] = \WxPayConfig::getValue('appsecret');
		$urlObj["code"] = $code;
